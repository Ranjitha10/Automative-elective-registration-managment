...
<form id="topic" method="post" action="feat/ance/ancedb.php" >
 
				<B style="">Elective&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</B> 
				<?php
				    echo '<input type="text"  name="Name"  value="'.$ele_name.'" readonly> ';  ?>
...
<br>
				<table class="CSSTableGenerator">
					<tbody>
						<tr>
							<td><B style="">STUDENT USN</B></td>
							<td><B style="">CLASS ATTENDED</B></td>
...
asort($usn);
		foreach ($usn as $value) 
		{
 		   ...
 		   echo "<tr>
			<td ><input style='color:black;background:transparent;border:none;font-size:14px;width:80%' name='".$d."'  type='text' value='".$value."' required/></td>
			<td ><input name='".$c."'  style='color:black;background:transparent;border:none;font-size:14px;width:80%' type='text'  /></td>
			</tr>";
